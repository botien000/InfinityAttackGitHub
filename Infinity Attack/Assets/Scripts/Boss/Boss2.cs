...
public class Boss2 : MonoBehaviour
{
    ...
    public void Skill1()
    {
        if (canSkill1 == true && Skill1_isCD == false)
        {
            ...
            Skill1_ing = true;
            Skill1_isCD = true;
            Instantiate(Resources.Load("Prefabs/BossSkill/Skill1_FireWizard"), player.transform.position, Quaternion.identity);
    ...
    public void Skill2()
    {
        if (activeskill2 && canSkill2)
        {
            ...
            heart = (GameObject)Instantiate(Resources.Load("Prefabs/Boss/Weakness_Boss2"), HeartSpawn.transform.position, Quaternion.identity);
